...
This sample machine learning project demonstrates how to automate ticket dispatching using a serverless, production-ready MLOps workflow on AWS. It showcases how an end-to-end system can classify incoming incident tickets, predict the correct support team, and automatically dispatch them to Microsoft Teams and assign agent to the ticket on the company ITSM (iTop).
